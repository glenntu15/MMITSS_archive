...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    def ComputeCycleTime(Start_Time, datalist, ismajor):
        ...
        for record in datalist:   # t = last_epoc + (record[0] - last_epoc) / 2
            ...
            if (indicator != CycleData.last_indicator):
                ...
                if (result > 0 ):
                    ...
                    tredgreen = CycleData.redtime + CycleData.greentime
                    if (tredgreen < shortestredgreen):
                        shortestredgreen = tredgreen 
        ...
        return (cycletime,markpoints,avgred, avggreen, avgyellow, shortestredgreen)
